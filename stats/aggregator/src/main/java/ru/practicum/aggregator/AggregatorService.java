...
public class AggregatorService {
    ...
    private void recalculateSimilarity(long eventA, Instant timestamp) {
    ...
    private void sendSimilarityToKafka(long eventA, long eventB, double similarity, Instant timestamp) {
